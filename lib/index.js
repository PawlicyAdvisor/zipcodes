...
var codesUS = require('./codes'),
    ...
    manuallyAddedCodes = require('./manuallyAddedCodes').manuallyAddedCodes;
...
manuallyAddedCodes.forEach((code) => {
    codes.codes[code.zip] = code
    codes.stateMap[code.state].push(code.zip)
})
